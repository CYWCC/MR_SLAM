...
#
# 你的 bag topics:
#   /jackal0/velodyne_points  -> /robot_1/pointcloud
#   /jackal0/simu/imu    -> /robot_1/imu
#   /jackal1/velodyne_points  -> /robot_2/pointcloud
#   /jackal1/simu/imu    -> /robot_2/imu
#   /jackal2/velodyne_points  -> /robot_3/pointcloud
#   /jackal2/simu/imu    -> /robot_3/imu
#
# 使用方法:
...
JACKAL_BAG_PATH="/media/cyw/KESU/mapping_data/nebula_rawdata/C_Urban_Husky4_simu.bag"
...
start_topic_remapping() {
    ...
    log_config "  /jackal0/velodyne_points -> /robot_1/pointcloud"
    log_config "  /jackal0/simu/imu   -> /robot_1/imu"
    log_config "  /jackal1/velodyne_points -> /robot_2/pointcloud"
    log_config "  /jackal1/simu/imu   -> /robot_2/imu"
    # log_config "  /jackal2/velodyne_points -> /robot_3/pointcloud"
    # log_config "  /jackal2/simu/imu   -> /robot_3/imu"
}
...
show_help() {
    ...
    echo ""
    echo "Topic 映射:"
    echo "  /jackal0/velodyne_points -> /robot_1/pointcloud"
    echo "  /jackal0/simu/imu   -> /robot_1/imu"
    echo "  /jackal1/velodyne_points -> /robot_2/pointcloud"
    echo "  /jackal1/simu/imu   -> /robot_2/imu"
    # echo "  /jackal2/velodyne_points -> /robot_3/pointcloud"
    # echo "  /jackal2/simu/imu   -> /robot_3/imu"
    echo ""
    echo "示例:"
    echo "  $0 run"
    echo "  $0 remap"
